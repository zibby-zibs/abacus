...
const stats = [
  {
    value: (
      <>
        2,400<span className="text-gold-600 dark:text-gold-500">+</span>
      </>
    ),
  ...
  return (
    <div className="flex flex-col items-start gap-2.5 px-0 py-8 sm:px-12 lg:px-20">
      <div
        className={cn(
          serif,
          "text-[clamp(3.25rem,6vw,5.5rem)] leading-none font-normal tracking-[-0.035em] text-forest-900 dark:text-offwhite"
        )}
      >
        {value}
      </div>
