      ...
      <div className="relative mx-auto grid max-w-container grid-cols-1 items-center gap-16 lg:grid-cols-2 lg:gap-[100px]">
        <div>
          ...
          >
            ...
            <em className="italic text-gold-600 dark:text-gold-500">actually</em>{" "}
            talk.
          </h2>
          ...
          <div className="overflow-hidden rounded-3xl border border-neutral-300/80 bg-surface shadow-[0_0_0_1px_rgba(245,200,66,0.08),0_32px_80px_rgba(13,30,23,0.08)] dark:border-white/10 dark:bg-surface dark:shadow-[0_0_0_1px_rgba(245,200,66,0.04),0_32px_80px_rgba(0,0,0,0.6),0_0_120px_rgba(26,58,46,0.3)]">
            ...
            <div className="flex flex-col gap-2 bg-forest-50/60 p-5 dark:bg-[#101a13]">
              ...
              <div className="max-w-[80%] self-start rounded-2xl rounded-bl-sm border border-neutral-300/60 bg-offwhite px-3.5 py-2.5 text-sm leading-normal text-forest-900/90 dark:border-white/10 dark:bg-surface-raised dark:text-foreground/85">
                Got it — <span className="font-mono text-[13px] font-medium text-gold-600 dark:text-gold-500">₦4,500</span> for Food at Chicken Republic.
                <br />
                You&apos;ve spent{" "}
                <span className="font-mono text-[13px] font-medium text-gold-600 dark:text-gold-500">₦18,200</span> on food this month.{" "}
                <span className="font-mono text-[13px] font-medium text-gold-600 dark:text-gold-500">₦21,800</span> left in your budget.
                <div className="mt-1 text-right text-[9.5px] text-neutral-600 dark:text-foreground-muted">
                  10:41
                </div>
              </div>
              ...
              <div className="max-w-[80%] self-start rounded-2xl rounded-bl-sm border border-neutral-300/60 bg-offwhite px-3.5 py-2.5 text-sm leading-normal text-forest-900/90 dark:border-white/10 dark:bg-surface-raised dark:text-foreground/85">
                ...
                <span className="font-mono text-[13px] font-medium text-gold-600 dark:text-gold-500">₦15,000</span>.
                <div className="mt-1 text-right text-[9.5px] text-neutral-600 dark:text-foreground-muted">
                  10:43
                </div>
              </div>
              ...
              <div className="max-w-[80%] self-start rounded-2xl rounded-bl-sm border border-neutral-300/60 bg-offwhite px-3.5 py-2.5 text-sm leading-normal text-forest-900/90 dark:border-white/10 dark:bg-surface-raised dark:text-foreground/85">
                <span className="font-mono text-[13px] font-medium text-gold-600 dark:text-gold-500">₦31,400</span> this week across 12 transactions.
                <br />
                Food:{" "}
                <span className="font-mono text-[13px] font-medium text-gold-600 dark:text-gold-500">₦18,200</span> · Transport:{" "}
                <span className="font-mono text-[13px] font-medium text-gold-600 dark:text-gold-500">₦7,800</span> · Other:{" "}
                <span className="font-mono text-[13px] font-medium text-gold-600 dark:text-gold-500">₦5,400</span>
                <div className="mt-1 text-right text-[9.5px] text-neutral-600 dark:text-foreground-muted">
                  10:45
                </div>
              </div>
