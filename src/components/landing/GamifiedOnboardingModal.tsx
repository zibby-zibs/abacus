...
const LS_KEY = "abakus-landing-gamified-onboarding";
...
function reactionLine(food: boolean, transport: boolean): string {
	if (!food && !transport)
		return "Yeah — most of us are guessing. That's the whole point of Abakus.";
	if (food && transport)
						...
						{step === 2 && food !== null && transport !== null ? (
							<>
								...
								<p className="mt-3 text-[13px] leading-relaxed text-neutral-600 dark:text-foreground-muted/85">
									Abakus lives in WhatsApp — you text what you spent, it
									remembers categories, budgets, and debts. No spreadsheet
									cosplay.
								</p>
