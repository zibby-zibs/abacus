...
const steps = [
  ...
  },
  {
    n: "02",
    title: "Talk normally",
    desc: 'Tell it what you spent, what you\'re owed, what your budget is. Plain English and Nigerian context fully understood — "okada", "NEPA", "5k".',
  },
  {
    n: "03",
    title: "Always know",
      ...
      <div className="relative mx-auto grid max-w-container grid-cols-1 items-start gap-16 lg:grid-cols-[1fr_1.8fr] lg:gap-[100px]">
        <div className="lg:sticky lg:top-[140px]">
          ...
          >
            ...
            <em className="italic text-gold-600 dark:text-gold-500">a minute.</em>
          </h2>
        </div>
